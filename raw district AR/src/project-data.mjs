...
export const project = {
  ...
  homeHref: "/",
  assetVersion: "20260605-direct-verification-1",
...
export const arabicProject = {
  ...
  seo: {
    title: "Raw District Dubai | Oaklyn Realty",
    description:
      "راجع تفاصيل Raw District by IMTIAZ في وسط جبل علي مع Oaklyn Realty، بما يشمل السعر وخطة الدفع والموقع."
  },
  locale: {
    lang: "ar",
    dir: "rtl"
  ...
  hero: {
    eyebrow: "مقدم من Oaklyn Realty",
    title: "Raw District by IMTIAZ",
    subtitle:
      "عنوان سكني وعملي متكامل على شارع الشيخ زايد مع وصول مباشر للمترو، مقدم بإرشاد واضح.",
    background: asset("photos/raw-district-exterior-evening.jpg"),
  ...
  gallery: {
    ...
    items: [
      ...
      {
        eyebrow: "المنطقة والمترو",
        title: "المنطقة والمترو",
        image: asset("photos/raw-district-aerial-metro.jpg")
      }
    ]
  },
  ...
  faq: [
    ...
    {
      question: "هل تضمن Oaklyn Realty العوائد؟",
      answer: "لا. Oaklyn Realty لا تضمن عائد الاستثمار أو الدخل الإيجاري أو قيمة إعادة البيع."
    }
  ],
  form: {
    ...project.form,
    title: "طلب تفاصيل Raw District",
    text: "شارك بياناتك وسيتواصل معك فريق Oaklyn Realty بآخر المتاح وخيارات الوحدات وإرشادات خطة الدفع.",
    labels: {
      name: "الاسم الكامل",
      phone: "رقم الهاتف",
    ...
    whatsappAlternativeLabel: "هل تفضل واتساب؟",
    whatsappButtonLabel: "تواصل عبر واتساب",
    privacyText:
      "بتقديم هذا النموذج، أوافق على سياسة الخصوصية وأوافق على التواصل معي من قبل Oaklyn Realty.",
    consent:
      "بتقديم هذا النموذج، توافق على التواصل معك من قبل Oaklyn Realty فيما يخص استفسارك العقاري.",
    sensitiveDataNotice:
  ...
  uiText: {
    ...
    form_submit: "طلب معلومات المشروع",
