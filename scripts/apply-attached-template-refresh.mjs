...
<style id="raw-ar-attached-template-css">
  ...
  .raw-attached-template .permit-qr-badge:hover,.raw-attached-template .permit-qr-badge:focus-visible{transform:translateY(-2px);border-color:rgba(201,168,76,.62);box-shadow:0 18px 42px rgba(0,0,0,.34);outline:0}
...
<a class="permit-qr-badge" href="/assets/raw-district/permit-qr.jpeg?v=20260618-permit-qr" target="_blank" rel="noopener" aria-label="عرض رمز تصريح المشروع" data-permit-qr-badge>
