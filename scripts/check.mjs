...
const standaloneEnglishHtml = await readFile(path.join(distDir, "index.html"), "utf8");
assert(standaloneEnglishHtml.includes("window.OAKLYN_LANDING_CONFIG"), "index.html: missing landing config");
assert(standaloneEnglishHtml.includes('"language_prompt_enabled": false'), "index.html: public page should not use language popup");
assert(standaloneEnglishHtml.includes('"language_switcher_enabled": false'), "index.html: language switcher should be disabled");
assert(standaloneEnglishHtml.includes('"language_routes"'), "index.html: missing language route config");
assert(standaloneEnglishHtml.includes('"/index.html"'), "index.html: missing standalone English route");
assert(standaloneEnglishHtml.includes('"/index-ar.html"'), "index.html: missing standalone Arabic route");
assert(standaloneEnglishHtml.includes(GTM_CONTAINER_ID), "index.html: missing GTM container");
assert(!standaloneEnglishHtml.includes("data-language-choice-overlay"), "index.html: public page should not render language popup");
...
assert(standaloneArabicHtml.includes("تواصل عبر واتساب"), "Standalone Arabic file: missing Arabic WhatsApp CTA");
